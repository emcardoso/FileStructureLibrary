 ...
 * árvore Vermelho e preta para memorizar cada valor gerado, o que tem 
 * impcatos no consumo de memória e no tempo de execução.
 * </p>
 * <p>
 * Note que o método gen, dessa classe, irá invocar o método gen do gerador
...
public class Unique<A> implements Rgen<A> {
     ...
     * gerador de dados a ser tornado único e inicaliza a árvore balanceada.
     * 
     * @param g
    ...
    /**
     * Gera um valor randâmico único. O valor gerado é armazenado em um árovre
